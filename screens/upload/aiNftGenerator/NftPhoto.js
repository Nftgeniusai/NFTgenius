...
const Photos = ({image, setImage, missing, promtNegative, setPromtNegative, postId, setPromt, promt, loading, setLoading, setLoadingTitle, setUploadedImage}) => {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      setLoading(true);
      setLoadingTitle('Uploading your selected image')
  ...
  useEffect(() => {
    setLoadingTitle('Generating your NFT collection...')
  }, []);
  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.logo}>
          <Text style={styles.titleInput}>Upload image <Text style={styles.optional}>(optional)</Text></Text>
      </View>
      ...
      <View style={styles.wrapperInput}>
          <Text style={styles.titleInput}>Add postive prompts</Text>
          <View style={styles.wrapperInner}>
            ...
            <TextInput 
              ...
              multiline
              numberOfLines={2}
              onChangeText={promt => setPromt(promt)}
              value={promt}
              /> }
          </View>
        </View>
        <View style={styles.wrapperInput}>
          <Text style={styles.titleInput}>Add negative prompts</Text>
          <View style={styles.wrapperInner}>
            { loading ? <View style={[styles.containerInput, styles.horizontal]}><ActivityIndicator size="large" color={COLORS.green} /></View> : 
            <TextInput 
              style={styles.textInputGenerated}
              ...
              multiline
              numberOfLines={2}
              onChangeText={promtNegative => setPromtNegative(promtNegative)}
              value={promtNegative}
              /> }
          </View>
        </View>
