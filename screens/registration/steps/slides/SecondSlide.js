  ...
  return (
    <View style={styles.container}>
        <View style={styles.imageWrapper}>
          <Image
                style={{
                  width: normalize(SCREEN_HEIGHT > 700 ? 396 : 264),
        ...
        <View>
          <Text style={{ fontFamily: FONTS.regular, color: "rgba(238, 238, 238, 1)", textAlign: "center", fontSize: normalize(14) }}>Stored on Blockchain</Text>
        </View>
        <View>
            <Text style={{ fontFamily: FONTS.preety, color: "rgba(238, 238, 238, 1)", textAlign: "center", fontSize: normalize(18), lineHeight: 50 }}>Storing your memories for ages</Text>
        </View>
        <View>
